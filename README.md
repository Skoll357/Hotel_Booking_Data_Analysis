...
# Project Structure
**data:**
Stores the original dataset and cleaned intermediate products.
**sql:**
Includes the complete SQL chain from cleaning and diagnostics to revenue analysis.
**scripts:**
Python scripts for visualization generation.
**visuals:**
Exported statistical charts (PNG/CSV).
**docs:**
Final strategic analysis report and explanatory documents.
